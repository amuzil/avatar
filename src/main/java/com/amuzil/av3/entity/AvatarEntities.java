...
public class AvatarEntities {
    ...
    public static final Supplier<EntityType<AvatarSoftBlock>> AVATAR_SOFT_BLOCK_ENTITY_TYPE =
            registerPhysicsBody("avatar_soft_block", AvatarSoftBlock::new, 1.0f, 1.0f, 10, 4);
