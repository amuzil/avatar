...
public class RigidBlock extends FallingBlockEntity implements EntityPhysicsElement {
    private final EntityRigidBody rigidBody;
    private static final EntityDataAccessor<Float> WIDTH = SynchedEntityData.defineId(RigidBlock.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Float> HEIGHT = SynchedEntityData.defineId(RigidBlock.class, EntityDataSerializers.FLOAT);

    public RigidBlock(EntityType<? extends FallingBlockEntity> type, Level level) {
        super(type, level);
