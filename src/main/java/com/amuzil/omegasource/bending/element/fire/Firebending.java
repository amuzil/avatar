...
import com.amuzil.omegasource.bending.element.fire.forms.FirePullForm;
...
public class Firebending extends Element {
    ...
    public static final RegistryObject<? extends Skill> FIRE_PULL_FORM = Registries.registerSkill(FirePullForm::new);
