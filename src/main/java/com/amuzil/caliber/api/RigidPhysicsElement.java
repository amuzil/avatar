 ...
 * It provides the basic components that a {@link RigidPhysicsElement} needs in order
 * to behave properly in the {@link MinecraftSpace}.
 * 
 * @since 1.0.0
 */
public interface RigidPhysicsElement<T> extends PhysicsElement<T> {

    /**
     * Gets {@link ElementRigidBody} object associated with this element. You should
     * create and store this in your {@link RigidPhysicsElement} implementation in the
     ...
     */
    @Nullable
    ElementRigidBody getPhysicsBody();
