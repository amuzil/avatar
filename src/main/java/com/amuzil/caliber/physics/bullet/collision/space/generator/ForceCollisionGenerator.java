...
public class ForceCollisionGenerator {
...
//                continue;
            ...
            ForcePhysicsElement forceRigidBody = (ForcePhysicsElement) rigidBody.getElement().cast();
            if (!(forceRigidBody instanceof ForcePoint point)) continue;
            point.syncFromPhysics();
            Vec3 current = point.pos();
            Vec3 lastPos = point.prevPos();
            Vec3 delta = current.subtract(lastPos);

            // TODO: Make a new supplier?
