...
public class EntityRigidBody extends ElementRigidBody {
    ...
    public EntityRigidBody(EntityRigidPhysicsElement element, MinecraftSpace space, MinecraftShape shape, float mass, float dragCoefficient, float friction, float restitution) {
        super(element, space, shape, mass, dragCoefficient, friction, restitution);
    }

    public EntityRigidBody(EntityRigidPhysicsElement element, MinecraftSpace space, MinecraftShape shape) {
     ...
     */
    public EntityRigidBody(EntityRigidPhysicsElement element) {
