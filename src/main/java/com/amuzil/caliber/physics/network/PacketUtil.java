...
public class PacketUtil {
    ...
    static <T extends CaliberPacket> void receiveClientMessage(final T message, IPayloadContext context) {
    ...
    static <T extends CaliberPacket> void receiveServerMessage(final T message, IPayloadContext context) {
        LogicalSide sideReceived = context.flow().getReceptionSide();
